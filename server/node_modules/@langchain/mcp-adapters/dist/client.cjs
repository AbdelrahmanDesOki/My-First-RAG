...
exports.MultiServerMCPClient = exports.MCPClientError = exports.createClientConfigSchema = exports.createConnectionSchema = exports.createStreamableHTTPConnectionSchema = exports.createStreamableReconnectSchema = exports.createStdioConnectionSchema = exports.createStdioRestartSchema = void 0;
...
exports.createStreamableReconnectSchema = createStreamableReconnectSchema;
/**
...
function createStreamableHTTPConnectionSchema() {
    return zod_1.z
         ...
         * @default false
         */
        useNodeEventSource: zod_1.z.boolean().optional().default(false),
        /**
...
exports.createStreamableHTTPConnectionSchema = createStreamableHTTPConnectionSchema;
/**
...
class MultiServerMCPClient {
    ...
    async _initializeStreamableHTTPConnection(serverName, connection) {
        ...
        if (transportType === "http" || transportType == null) {
            const transport = await this._createStreamableHTTPTransport(serverName, url, headers, reconnect);
            this._transportInstances[serverName] = transport;
            const client = new index_js_1.Client({
                name: "langchain-mcp-adapter",
                version: "0.1.0",
    ...
    async _createStreamableHTTPTransport(serverName, url, headers, reconnect) {
        if (!headers) {
            // Simple case - no headers, use default transport
